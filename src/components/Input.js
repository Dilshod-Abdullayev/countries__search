...
export default function Input() {
    ...
    return (
        <div style={{ marginTop: '100px' }}>
            <h1>{filteredList.length}ta davlat topildi</h1>
            ...
            <div class="relative mt-2">
                ...
                <input
                    ...
                    type="search" id="search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600
